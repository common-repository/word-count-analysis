...
class WCA_StopWords {
	...
	public function getWordsList() {
		$stopWordsFilePath = WCA_LIBS . '/stopwords/' . self::getActualLocaleName( $this->langCode ) . '.txt';
		if ( file_exists( $stopWordsFilePath ) ) {
	...
	public function remove( $string, $stripPunct = false ) {
		...
		switch ( preg_last_error() ) {
			...
			case PREG_BACKTRACK_LIMIT_ERROR:
				_e(PHP_EOL . "preg:PREG_BACKTRACK_LIMIT_ERROR" . PHP_EOL);
				break;
			case PREG_RECURSION_LIMIT_ERROR:
				echo PHP_EOL . "preg:PREG_RECURSION_LIMIT_ERROR" . PHP_EOL;
				break;
			case PREG_BAD_UTF8_ERROR:
				echo PHP_EOL . "preg:PREG_BAD_UTF8_ERROR" . PHP_EOL;
				break;
			case PREG_BAD_UTF8_OFFSET_ERROR:
				echo PHP_EOL . "preg:PREG_BAD_UTF8_OFFSET_ERROR" . PHP_EOL;
				break;
			case PREG_JIT_STACKLIMIT_ERROR:
				echo PHP_EOL . "preg:PREG_JIT_STACKLIMIT_ERROR" . PHP_EOL;
				break;
		}
		if ( $stripPunct ) {
